...
class _AdminAccountViewState extends State<AdminAccountView> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(backgroundColor: Color(0xffF8F0E1),
        ),
               ...
               children: [
                 ...
                 Card(
                     ...
                     child: Column(
                       children: [
                         ListTile(
                           leading: Icon(Icons.headset_mic_outlined,size: 25,color: Colors.black,),
                           title: Text("Contact Us",style: GoogleFonts.inter(
                             textStyle: Theme.of(context).textTheme.displayLarge,
                         ...
                         Divider(),
                         ListTile(
                           leading: Icon(Icons.error_outline,size: 20,color: Colors.black,),
