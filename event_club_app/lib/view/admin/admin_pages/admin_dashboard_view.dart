            ...
            itemBuilder: (BuildContext context) => [
              PopupMenuItem(
                ...
                onPressed: () { Navigator.pushReplacement(
                  context,
                  MaterialPageRoute(builder: (context) => AdminAccountView()),);
                },
                  ...
                  child: const Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        CircleAvatar(
                          radius: 52,
                          backgroundImage:AssetImage("assets/images/user.admin.png"),
                        ),
                        SizedBox(
                          height: 12,
                        ),
                        Text(
                          'Admin',
                          style: TextStyle(fontSize: 24,fontWeight: FontWeight.w400, color: Color(0xfff000000),),
                        ),
                        Text(
                          'admin@gmail.com',
                          style: TextStyle(fontSize: 16,fontWeight: FontWeight.w400, color: Color(0xfff000000)),
                        ),
                      ],
                    ),
                  ),
              ...
              child: Container(
                ...
                child: ListTile(
                  title: const Padding(
                    ...
                    child: Text('Total User',style:TextStyle(fontSize: 20,fontWeight: FontWeight.w500),),
                  ),
                  onTap: () {
                    Navigator.pop(context);
                  },
              ...
              child: Container(
                ...
                child: ListTile(
                  title: const Padding(
                    ...
                    child: Text('Active User',style:TextStyle(fontSize: 20,fontWeight: FontWeight.w500)),
                  ),
                  onTap: () {
                    Navigator.pop(context);
                  },
            ...
            Padding(
              ...
              child: Container(
                ...
                child: ListTile(
                  title: const Padding(
                    padding: EdgeInsets.symmetric(horizontal: 49),
                    child: Text('Block User',style:TextStyle(fontSize: 20,fontWeight: FontWeight.w500)),
                  ),
                  onTap: () {
                    Navigator.pop(context);
                  },
            ...
            Padding(
              ...
              child: Container(
                ...
                child: ListTile(
                  title: const Padding(
                    padding: EdgeInsets.symmetric(horizontal: 49),
                    child: Text('Vendor',style:TextStyle(fontSize: 20,fontWeight: FontWeight.w500)),
                  ),
                  onTap: () {
                    Navigator.pop(context);
                  },
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Text("admin@gmail.com",style: GoogleFonts.inter
                        (textStyle: Theme.of(context).textTheme.displayLarge,
                        fontSize: 15,
                        fontWeight: FontWeight.w600,)
                      )
                  ...
                  Column(
                    ...
                    children: [
                      Text("Dashboard",style: GoogleFonts.inter
                       ...
                       Text("08 March 2024",style: GoogleFonts.inter
                         (textStyle: Theme.of(context).textTheme.displayLarge,
                          fontSize: 13,
                           fontWeight: FontWeight.w600,
                       )
                        ...
                        child: Center(
                          child:TextButton(onPressed: (){
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                builder: (context) => const CreateVendor(),
                            )
                            );
                          },
